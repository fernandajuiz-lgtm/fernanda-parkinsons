...
- Entrada alternativa com auto-formatação (digitar "830" resulta em "08:30")
...
- Degradação amigável: se a IA falhar, insights locais permanecem disponíveis
...
- Classificação em 5 níveis (Nenhum, Leve, Moderado, Forte, Intenso)
...
### Pré-requisitos
- Node.js (versão LTS) — disponível em nodejs.org
